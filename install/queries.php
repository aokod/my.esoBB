...
$queries[] = "DROP TABLE IF EXISTS {$tablePrefix}conversations";
$queries[] = "CREATE TABLE {$tablePrefix}conversations (
...
) ENGINE={$storageEngine} DEFAULT CHARSET={$characterEncoding}";

// Create the posts table.
$queries[] = "DROP TABLE IF EXISTS {$tablePrefix}posts";
$queries[] = "CREATE TABLE {$tablePrefix}posts (
...
$queries[] = "DROP TABLE IF EXISTS {$tablePrefix}status";
$queries[] = "CREATE TABLE {$tablePrefix}status (
	conversationId int unsigned NOT NULL,
...
$queries[] = "DROP TABLE IF EXISTS {$tablePrefix}members";
$queries[] = "CREATE TABLE {$tablePrefix}members (
...
$queries[] = "DROP TABLE IF EXISTS {$tablePrefix}tags";
$queries[] = "CREATE TABLE {$tablePrefix}tags (
...
$queries[] = "DROP TABLE IF EXISTS {$tablePrefix}searches";
$queries[] = "CREATE TABLE {$tablePrefix}searches (
	ip char(32) NOT NULL,
	searchTime int unsigned NOT NULL
) ENGINE={$storageEngine} DEFAULT CHARSET={$characterEncoding}";

// Create the logins table.
$queries[] = "DROP TABLE IF EXISTS {$tablePrefix}logins";
$queries[] = "CREATE TABLE {$tablePrefix}logins (
	ip char(32) NOT NULL,
...
//}
$color = rand(1, 27);
$queries[] = "INSERT INTO {$tablePrefix}members (memberId, name, email, password, salt, color, account) VALUES 
(1, '{$_SESSION["install"]["adminUser"]}', '{$_SESSION["install"]["adminEmail"]}', '$password', '$salt', $color, 'Administrator')";

// Create default conversations.
$time = time();
$queries[] = "INSERT INTO {$tablePrefix}conversations (conversationId, title, slug, sticky, posts, startMember, startTime, lastActionTime, private) VALUES
...
$queries[] = "INSERT INTO {$tablePrefix}posts (conversationId, memberId, time, title, content) VALUES
...
$queries[] = "INSERT INTO {$tablePrefix}status (conversationId, memberId, allowed) VALUES (3, 1, 1)";

// Add tags for the default conversations.
$queries[] = "INSERT INTO {$tablePrefix}tags (conversationId, tag) VALUES (1, 'welcome'), (1, 'introduction'), (2, 'esobb'), (2, 'tutorial'), (2, 'faq'), (2, 'howto'), (3, 'esobb'), (3, 'customization'), (3, 'tutorial'), (3, 'administration')";
